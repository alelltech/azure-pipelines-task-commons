...
//   ['Build.Repository.Clean'] = 'BUILD_REPOSITORY_CLEAN',
...
//   ['Build.Repository.Provider'] = 'BUILD_REPOSITORY_PROVIDER',
//   ['Build.Repository.Tfvc.Workspace'] = '_',
...
//   ['Build.Repository.Git.SubmoduleCheckout'] = 'BUILD_REPOSITORY_GIT.SUBMODULECHECKOUT',
...
export type variablesMap = {
  'Agent.BuildDirectory': 'AGENT_BUILDDIRECTORY',                                              'AGENT_BUILDDIRECTORY': 'Agent.BuildDirectory',
  'Agent.ContainerMapping': 'AGENT_CONTAINERMAPPING',                                          'AGENT_CONTAINERMAPPING': 'Agent.ContainerMapping',
  'Agent.HomeDirectory': 'AGENT_HOMEDIRECTORY',                                                'AGENT_HOMEDIRECTORY': 'Agent.HomeDirectory',
  'Agent.Id': 'AGENT_ID',                                                                      'AGENT_ID': 'Agent.Id',
  'Agent.JobName': 'AGENT_JOBNAME',                                                            'AGENT_JOBNAME': 'Agent.JobName',
  'Agent.JobStatus': 'AGENT_JOBSTATUS',                                                        'AGENT_JOBSTATUS': 'Agent.JobStatus',
  'Agent.MachineName': 'AGENT_MACHINENAME',                                                    'AGENT_MACHINENAME': 'Agent.MachineName',
  'Agent.Name': 'AGENT_NAME',                                                                  'AGENT_NAME': 'Agent.Name',
  'Agent.OS': 'AGENT_OS',                                                                      'AGENT_OS': 'Agent.OS',
  'Agent.OSArchitecture': 'AGENT_OSARCHITECTURE',                                              'AGENT_OSARCHITECTURE': 'Agent.OSArchitecture',
  'Agent.TempDirectory': 'AGENT_TEMPDIRECTORY',                                                'AGENT_TEMPDIRECTORY': 'Agent.TempDirectory',
  'Agent.ToolsDirectory': 'AGENT_TOOLSDIRECTORY',                                              'AGENT_TOOLSDIRECTORY': 'Agent.ToolsDirectory',
  'Agent.WorkFolder': 'AGENT_WORKFOLDER',                                                      'AGENT_WORKFOLDER': 'Agent.WorkFolder',
  'Build.ArtifactStagingDirectory': 'BUILD_ARTIFACTSTAGINGDIRECTORY',                          'BUILD_ARTIFACTSTAGINGDIRECTORY': 'Build.ArtifactStagingDirectory',
  'Build.BuildId': 'BUILD_BUILDID',                                                            'BUILD_BUILDID': 'Build.BuildId',
  'Build.BuildNumber': 'BUILD_BUILDNUMBER',                                                    'BUILD_BUILDNUMBER': 'Build.BuildNumber',
  'Build.BuildUri': 'BUILD_BUILDURI',                                                          'BUILD_BUILDURI': 'Build.BuildUri',
  'Build.BinariesDirectory': 'BUILD_BINARIESDIRECTORY',                                        'BUILD_BINARIESDIRECTORY': 'Build.BinariesDirectory',
  'Build.ContainerId': 'BUILD_CONTAINERID',                                                    'BUILD_CONTAINERID': 'Build.ContainerId',
  'Build.CronSchedule.DisplayName': 'BUILD_CRONSCHEDULE_DISPLAYNAME',                          'BUILD_CRONSCHEDULE_DISPLAYNAME': 'Build.CronSchedule.DisplayName',
  'Build.DefinitionName': 'BUILD_DEFINITIONNAME',                                              'BUILD_DEFINITIONNAME': 'Build.DefinitionName',
  'Build.DefinitionVersion': 'BUILD_DEFINITIONVERSION',                                        'BUILD_DEFINITIONVERSION': 'Build.DefinitionVersion',
  'Build.QueuedBy': 'BUILD_QUEUEDBY',                                                          'BUILD_QUEUEDBY': 'Build.QueuedBy',
  'Build.QueuedById': 'BUILD_QUEUEDBYID',                                                      'BUILD_QUEUEDBYID': 'Build.QueuedById',
  'Build.Reason': 'BUILD_REASON',                                                              'BUILD_REASON': 'Build.Reason',
  'Build.Repository.Clean': 'BUILD_REPOSITORY_CLEAN',                                          'BUILD_REPOSITORY_CLEAN': 'Build.Repository.Clean',
  'Build.Repository.LocalPath': 'BUILD_REPOSITORY_LOCALPATH',                                  'BUILD_REPOSITORY_LOCALPATH': 'Build.Repository.LocalPath',
  'Build.Repository.ID': 'BUILD_REPOSITORY_ID',                                                'BUILD_REPOSITORY_ID': 'Build.Repository.ID',
  'Build.Repository.Name': 'BUILD_REPOSITORY_NAME',                                            'BUILD_REPOSITORY_NAME': 'Build.Repository.Name',
  'Build.Repository.Provider': 'BUILD_REPOSITORY_PROVIDER',                                    'BUILD_REPOSITORY_PROVIDER': 'Build.Repository.Provider',
  'Build.Repository.Tfvc.Workspace': '_',                        '_': 'Build.Repository.Tfvc.Workspace',
  'Build.Repository.Uri': 'BUILD_REPOSITORY_URI',                                              'BUILD_REPOSITORY_URI': 'Build.Repository.Uri',
  'Build.RequestedFor': 'BUILD_REQUESTEDFOR',                                                  'BUILD_REQUESTEDFOR': 'Build.RequestedFor',
  'Build.RequestedForEmail': 'BUILD_REQUESTEDFOREMAIL',                                        'BUILD_REQUESTEDFOREMAIL': 'Build.RequestedForEmail',
  'Build.RequestedForId': 'BUILD_REQUESTEDFORID',                                              'BUILD_REQUESTEDFORID': 'Build.RequestedForId',
  'Build.SourceBranch': 'BUILD_SOURCEBRANCH',                                                  'BUILD_SOURCEBRANCH': 'Build.SourceBranch',
  'Build.SourceBranchName': 'BUILD_SOURCEBRANCHNAME',                                          'BUILD_SOURCEBRANCHNAME': 'Build.SourceBranchName',
  'Build.SourcesDirectory': 'BUILD_SOURCESDIRECTORY',                                          'BUILD_SOURCESDIRECTORY': 'Build.SourcesDirectory',
  'Build.SourceVersion': 'BUILD_SOURCEVERSION',                                                'BUILD_SOURCEVERSION': 'Build.SourceVersion',
  'Build.SourceVersionMessage': 'BUILD_SOURCEVERSIONMESSAGE',                                  'BUILD_SOURCEVERSIONMESSAGE': 'Build.SourceVersionMessage',
  'Build.StagingDirectory': 'BUILD_STAGINGDIRECTORY',                                          'BUILD_STAGINGDIRECTORY': 'Build.StagingDirectory',
  'Build.Repository.Git.SubmoduleCheckout': 'BUILD_REPOSITORY_GIT_SUBMODULECHECKOUT',          'BUILD_REPOSITORY_GIT_SUBMODULECHECKOUT': 'Build.Repository.Git.SubmoduleCheckout',
  'Build.SourceTfvcShelveset': 'BUILD_SOURCETFVCSHELVESET',                                    'BUILD_SOURCETFVCSHELVESET': 'Build.SourceTfvcShelveset',
  'Build.TriggeredBy.BuildId': 'BUILD_TRIGGEREDBY_BUILDID',                                    'BUILD_TRIGGEREDBY_BUILDID': 'Build.TriggeredBy.BuildId',
  'Build.TriggeredBy.DefinitionId': 'BUILD_TRIGGEREDBY_DEFINITIONID',                          'BUILD_TRIGGEREDBY_DEFINITIONID': 'Build.TriggeredBy.DefinitionId',
  'Build.TriggeredBy.DefinitionName': 'BUILD_TRIGGEREDBY_DEFINITIONNAME',                      'BUILD_TRIGGEREDBY_DEFINITIONNAME': 'Build.TriggeredBy.DefinitionName',
  'Build.TriggeredBy.BuildNumber': 'BUILD_TRIGGEREDBY_BUILDNUMBER',                            'BUILD_TRIGGEREDBY_BUILDNUMBER': 'Build.TriggeredBy.BuildNumber',
  'Build.TriggeredBy.ProjectID': 'BUILD_TRIGGEREDBY_PROJECTID',                                'BUILD_TRIGGEREDBY_PROJECTID': 'Build.TriggeredBy.ProjectID',
  'Common.TestResultsDirectory': 'COMMON.TESTRESULTSDIRECTORY',                                'COMMON.TESTRESULTSDIRECTORY': 'Common.TestResultsDirectory',
  'Pipeline.Workspace': 'PIPELINE_WORKSPACE',                                                  'PIPELINE_WORKSPACE': 'Pipeline.Workspace',
  'Environment.Name': 'ENVIRONMENT_NAME',                                                      'ENVIRONMENT_NAME': 'Environment.Name',
  'Environment.Id': 'ENVIRONMENT_ID',                                                          'ENVIRONMENT_ID': 'Environment.Id',
  'Environment.ResourceName': 'ENVIRONMENT_RESOURCENAME',                                      'ENVIRONMENT_RESOURCENAME': 'Environment.ResourceName',
  'Environment.ResourceId': 'ENVIRONMENT_RESOURCEID',                                          'ENVIRONMENT_RESOURCEID': 'Environment.ResourceId',
  'Strategy.Name': 'STRATEGY_NAME',                                                            'STRATEGY_NAME': 'Strategy.Name',
  'Strategy.CycleName': 'STRATEGY_CYCLENAME',                                                  'STRATEGY_CYCLENAME': 'Strategy.CycleName',
  'System.AccessToken': 'SYSTEM_ACCESSTOKEN',                                                  'SYSTEM_ACCESSTOKEN': 'System.AccessToken',
  'System.CollectionId': 'SYSTEM_COLLECTIONID',                                                'SYSTEM_COLLECTIONID': 'System.CollectionId',
  'System.CollectionUri': 'SYSTEM_COLLECTIONURI',                                              'SYSTEM_COLLECTIONURI': 'System.CollectionUri',
  'System.DefaultWorkingDirectory': 'SYSTEM_DEFAULTWORKINGDIRECTORY',                          'SYSTEM_DEFAULTWORKINGDIRECTORY': 'System.DefaultWorkingDirectory',
  'System.DefinitionId': 'SYSTEM_DEFINITIONID',                                                'SYSTEM_DEFINITIONID': 'System.DefinitionId',
  'System.HostType': 'SYSTEM_HOSTTYPE',                                                        'SYSTEM_HOSTTYPE': 'System.HostType',
  'System.JobAttempt': 'SYSTEM_JOBATTEMPT',                                                    'SYSTEM_JOBATTEMPT': 'System.JobAttempt',
  'System.JobDisplayName': 'SYSTEM_JOBDISPLAYNAME',                                            'SYSTEM_JOBDISPLAYNAME': 'System.JobDisplayName',
  'System.JobId': 'SYSTEM_JOBID',                                                              'SYSTEM_JOBID': 'System.JobId',
  'System.JobName': 'SYSTEM_JOBNAME',                                                          'SYSTEM_JOBNAME': 'System.JobName',
  'System.PhaseAttempt': 'SYSTEM_PHASEATTEMPT',                                                'SYSTEM_PHASEATTEMPT': 'System.PhaseAttempt',
  'System.PhaseDisplayName': 'SYSTEM_PHASEDISPLAYNAME',                                        'SYSTEM_PHASEDISPLAYNAME': 'System.PhaseDisplayName',
  'System.PhaseName': 'SYSTEM_PHASENAME',                                                      'SYSTEM_PHASENAME': 'System.PhaseName',
  'System.PlanId': 'SYSTEM_PLANID',                                                            'SYSTEM_PLANID': 'System.PlanId',
  'System.PullRequest.IsFork': 'SYSTEM_PULLREQUEST_ISFORK',                                    'SYSTEM_PULLREQUEST_ISFORK': 'System.PullRequest.IsFork',
  'System.PullRequest.PullRequestId': 'SYSTEM_PULLREQUEST_PULLREQUESTID',                      'SYSTEM_PULLREQUEST_PULLREQUESTID': 'System.PullRequest.PullRequestId',
  'System.PullRequest.PullRequestNumber': 'SYSTEM_PULLREQUEST_PULLREQUESTNUMBER',              'SYSTEM_PULLREQUEST_PULLREQUESTNUMBER': 'System.PullRequest.PullRequestNumber',
  'System.PullRequest.targetBranchName': 'SYSTEM_PULLREQUEST_TARGETBRANCHNAME',                'SYSTEM_PULLREQUEST_TARGETBRANCHNAME': 'System.PullRequest.targetBranchName',
  'System.PullRequest.SourceBranch': 'SYSTEM_PULLREQUEST_SOURCEBRANCH',                        'SYSTEM_PULLREQUEST_SOURCEBRANCH': 'System.PullRequest.SourceBranch',
  'System.PullRequest.SourceCommitId': 'SYSTEM_PULLREQUEST_SOURCECOMMITID',                    'SYSTEM_PULLREQUEST_SOURCECOMMITID': 'System.PullRequest.SourceCommitId',
  'System.PullRequest.SourceRepositoryURI': 'SYSTEM_PULLREQUEST_SOURCEREPOSITORYURI',          'SYSTEM_PULLREQUEST_SOURCEREPOSITORYURI': 'System.PullRequest.SourceRepositoryURI',
  'System.PullRequest.TargetBranch': 'SYSTEM_PULLREQUEST_TARGETBRANCH',                        'SYSTEM_PULLREQUEST_TARGETBRANCH': 'System.PullRequest.TargetBranch',
  'System.StageAttempt': 'SYSTEM_STAGEATTEMPT',                                                'SYSTEM_STAGEATTEMPT': 'System.StageAttempt',
  'System.StageDisplayName': 'SYSTEM_STAGEDISPLAYNAME',                                        'SYSTEM_STAGEDISPLAYNAME': 'System.StageDisplayName',
  'System.StageName': 'SYSTEM_STAGENAME',                                                      'SYSTEM_STAGENAME': 'System.StageName',
  'System.TeamFoundationCollectionUri': 'SYSTEM_TEAMFOUNDATIONCOLLECTIONURI',                  'SYSTEM_TEAMFOUNDATIONCOLLECTIONURI': 'System.TeamFoundationCollectionUri',
  'System.TeamProject': 'SYSTEM_TEAMPROJECT',                                                  'SYSTEM_TEAMPROJECT': 'System.TeamProject',
  'System.TeamProjectId': 'SYSTEM_TEAMPROJECTID',                                              'SYSTEM_TEAMPROJECTID': 'System.TeamProjectId',
  'System.TimelineId': 'SYSTEM_TIMELINEID',                                                    'SYSTEM_TIMELINEID': 'System.TimelineId',
  'TF_BUILD': 'TF_BUILD',
  'Checks.StageAttempt': 'CHECKS_STAGEATTEMPT',                                                'CHECKS_STAGEATTEMPT': 'Checks.StageAttempt',
}
